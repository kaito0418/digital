...
y = [im0.mean(), im1.mean(), im2.mean(), im3.mean(), im4.mean(), im5.mean(), im6.mean(), im7.mean(), im8.mean(), im9.mean(), im10.mean(), im11.mean(), im12.mean(), im13.mean(), im14.mean(), im15.mean(), im16.mean(), im17.mean(), im18.mean(), im19.mean(), im20.mean(),
     ...
     im61.mean(), im62.mean(), im63.mean(), im64.mean(), im65.mean(), im66.mean(), im67.mean(), im68.mean(), im69.mean(), im70.mean(),im71.mean(), im72.mean(),im73.mean(), im74.mean(), im75.mean(), im76.mean(), im77.mean(), im78.mean(), im79.mean(), im80.mean(),
     im81.mean(), im82.mean(), im83.mean(), im84.mean()]
